...
export function Search(props: SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      ...
      <path
        fill="currentColor"
        d="M29.727 52.003L19.439 55.38a25.527 25.527 0 0 0 16.102 7.119zm32.765-10.75l-25.476 8.36l6.705 12.1a25.637 25.637 0 0 0 9.828-5.054a25.543 25.543 0 0 0 8.943-15.406M11.674 34.38a25.53 25.53 0 0 0 2.94 14.65l9.52-3.123zm48.328-9.234l-5.303 10.732l7.916-2.596a25.486 25.486 0 0 0-2.613-8.136"
        color="currentColor"
      ></path>
    </svg>
  );
